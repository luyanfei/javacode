...
public class Game extends Activity {
	...
	public static final String KEY_DIFFICULTY = "cn.jhc.sudoku.difficulty";
	...
	protected void onPause() {
		super.onPause();
		Music.stop(this);
		Log.d(TAG, "Save to preference: " + toPuzzleString(puzzle));
	...
	private static int[] fromPuzzleString(String string) {
		int[] puzzle = new int[string.length()];
		for (int i = 0; i < string.length(); i++)
			puzzle[i] = string.charAt(i) - '0';
		return puzzle;
	}
